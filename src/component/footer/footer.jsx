...
export default function Footer(){
    return (
        ...
        <h2 className="bg-gradient-to-r from-lime-500 via-green-500 to-emerald-700 bg-clip-text text-transparent md:text-2xl text-lg text-center font-extrabold">Scroll, Watch, Repeat!</h2>
        <div className="flex flex-row justify-center gap-4 text-emerald-700 ">
